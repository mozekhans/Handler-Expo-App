// // app/(app)/business/[id]/competitors/[competitorId]/edit.js
...
// export default function EditCompetitorScreen() {
...
//       setHasChanges(false);
//       Alert.alert('Success', 'Competitor updated successfully');
//       router.back();
//     },
//   });
...
//         industry: data.competitor.industry || '',
//         socialAccounts: data.competitor.socialAccounts || [],
//         analysis: {
//           strengths: data.competitor.analysis?.strengths || [],
//           weaknesses: data.competitor.analysis?.weaknesses || [],
//           opportunities: data.competitor.analysis?.opportunities || [],
//           threats: data.competitor.analysis?.threats || [],
//           marketShare: data.competitor.analysis?.marketShare || 0,
//           shareOfVoice: data.competitor.analysis?.shareOfVoice || 0,
//           uniqueSellingPoints: data.competitor.analysis?.uniqueSellingPoints || [],
//           targetAudience: data.competitor.analysis?.targetAudience || [],
//           pricing: data.competitor.analysis?.pricing || '',
//           positioning: data.competitor.analysis?.positioning || '',
//         },
//       });
//     }
//   }, [data]);
...
//     } catch (error) {
//       Alert.alert('Error', error.response?.data?.message || 'Failed to update competitor');
//     } finally {
//       setSaving(false);
//     }
//   };
